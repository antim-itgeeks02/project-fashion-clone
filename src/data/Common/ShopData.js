export const shopData = [
    {
        ...
        { name: 'Our Favourites', path: '/collections/our-favourites' },]
    },
    {
        heading: 'Shop by Brand', link: '/#', list: [{ name: 'Tag Heuer', path: '/collections/tag-heuer' },
        { name: 'Omega', path: '/collections/omega' },
        { name: 'IWC', path: '/collections/iwc' },
        ...
        { name: 'Theme Features', path: '/pages/theme-features' },
