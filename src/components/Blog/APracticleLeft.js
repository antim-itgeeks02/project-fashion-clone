...
const APracticleLeft = () => {
    return (
        <div className='aPracticleLeft'>
            ...
            <img src='https://cdn.shopify.com/s/files/1/1063/3618/files/iwc-cut.jpg?2277015729178659699' />
            <div >
                <ol style={{ display: 'flex', flexDirection: 'column-reverse', gap: '10px' }}>
                    ...
                    <img height={'253px'} src='https://cdn.shopify.com/s/files/1/1063/3618/files/pilot.jpg?2277015729178659699' />
